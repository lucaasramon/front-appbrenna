...
function NovoCadastro() {
    ...
    async function NovoCadastroSubmit(e) {
        ...
        if (nome == "" || email == "" || endereco == "" ||
            idade == "" || numero == "" || numeroEmergencia == "" || senha == "") {
                        ...
                        <div className="row">
                            <div className="input-field col s10 offset-s1">
                                <input value={nome} onChange={e => setNome(e.target.value)}
                                    id="name3" type="text" className="validate" />
                        ...
                        <div className="row">
                            <div className="input-field col s10 offset-s1">
                                <input value={email} onChange={e => setEmail(e.target.value)}
                                    id="email3" type="email" className="validate" />
                        ...
                        <div className="row">
                            <div className="input-field col s10 offset-s1">
                                <input value={endereco} onChange={e => setEndereco(e.target.value)}
                                    id="email3" type="text" className="validate" />
                        ...
                        <div className="row">
                            <div className="input-field col s10 offset-s1">
                                <input value={numero} onChange={e => setNumero(e.target.value)}
                                    id="phone3" type="tel" className="validate" />
                                <label for="phone3">Número</label>
                            </div>
                        </div>
                        <div className="row">
                            <div className="input-field col s10 offset-s1">
                                <input value={numeroEmergencia} onChange={e => setNumeroEmergencia(e.target.value)}
                                    id="phone3" type="tel" className="validate" />
                        ...
                        <div className="row">
                            <div className="input-field col s10 offset-s1">
                                <input value={senha} onChange={e => setSenha(e.target.value)}
                                    id="pass3" type="password" className="validate" />
                                <label for="pass3">Repita sua senha</label>
                            </div>
                        </div>

                        <div className="row center">
                            <button type="submit" className="waves-effect waves-light btn-large bg-primary">Salvar</button>
                            <div className="spacer"></div>
                            <div className="links">
                                <Link to="/"><a href="ui-pages-login.html" className='waves-effect'>Login</a> </Link>  </div>
                            <div className="spacer"></div>
                            <div className="spacer"></div>
                            <div className="spacer"></div>
                            <div className="spacer"></div>
