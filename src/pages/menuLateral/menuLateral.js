...
class MenuLateral extends Component {
    ...
    render() {
        return (
            <>
                <nav className="fix_topscroll logo_on_fixed  topbar navigation" role="navigation">
                    <div className="nav-wrapper container">
                        ...
                        <a href="#" data-target="slide-settings" className="waves-effect waves-circle navicon right sidenav-trigger show-on-large pulse"><i
                            className="mdi mdi-settings-outline"></i></a>

                        <a href="#" data-target="" className="waves-effect waves-circle navicon right nav-site-mode show-on-large"><i
                            className="mdi mdi-invert-colors mdi-transition1"></i></a>
                    </div>
                </nav>
                <ul id="slide-nav" className="sidenav sidemenu">
                    <li className="menu-close"><i className="mdi mdi-close"></i></li>
                    <li className="user-wrap">
                        <div className="user-view row">

                            <div className="col s9 infoarea">
                                <a href="ui-app-profile.html"><span className="name">Emma Bailey</span></a>
                                <a href="ui-app-profile.html"><span className="email">emma.bailey@gmail.com</span></a>
                            </div>
                        </div>
                    </li>
                    ...
                    <li className="menulinks">
                        ...
                        <li className="sh-wrap"><div className="subheader">Navigation</div></li>
                        <li className="lvl1 ">
                        ...
                        <li className="lvl1 ">
                            <div className="waves-effect "><a href="#" data-target="slide-settings" className="sidenav-trigger"><i className="mdi mdi-settings-outline"></i><span className="title">Settings</span>  </a>
                            </div></li><li className="sep-wrap"><div className="divider"></div></li><li className="sh-wrap"><div className="subheader">Prebuilt Apps</div></li>
                        <li className="lvl1 ">
                            <div className=" waves-effect " >
                        ...
                        </li><li className="sep-wrap"><div className="divider"></div></li><li className="sh-wrap"><div className="subheader">Get in Touch</div></li>
                        <li className="lvl1 ">
                            <div className="waves-effect ">
                                <a href="mailto:email@example.com">
                                    <i className="mdi mdi-email-outline"></i>
                                    <span className="title">Email</span>  </a>
                            </div></li>
                        <li className="lvl1 ">
                            <div className="waves-effect ">
                                <a href="tel:+1 234 567 890">
                                    <i className="mdi mdi-cellphone-basic"></i>
                                    <span className="title">Phone</span>  </a>
                            </div></li>
                        <li className="lvl1 ">
                            <div className="waves-effect ">
                                <a href="sms:+1 234 567 890">
                                    <i className="mdi mdi-message-text-outline"></i>
                                    <span className="title">Message</span>  </a>
                            </div></li>
                    </li>
                </ul>
            </>
